	...
	public static void main(String[] args) {
		...
		f.addKeyListener(new KeyListener(){
			...
			public void keyPressed(KeyEvent e) {
				try{
				if(e.getKeyCode()==KeyEvent.VK_UP) t.deplacement(0);
				if(e.getKeyCode()==KeyEvent.VK_DOWN) t.deplacement(1);
				if(e.getKeyCode()==KeyEvent.VK_LEFT) t.deplacement(2);
				if(e.getKeyCode()==KeyEvent.VK_RIGHT) t.deplacement(3);
